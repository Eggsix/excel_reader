...
(function() {
  var COL_JSON, COL_XLSX, ROW_JSON, ROW_XLSX, chai, expect, fs, processFile;
  ...
  describe('process file', function() {
    ...
    it('should process row oriented Excel files and return the parsed object', function(done) {
    ...
    it('should process col oriented Excel files', function(done) {
